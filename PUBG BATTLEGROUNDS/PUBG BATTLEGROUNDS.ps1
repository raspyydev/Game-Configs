...
Get-FileFromWeb -URL "https://github.com/raspyydev/Game-Configs/raw/refs/heads/main/PUBG%20BATTLEGROUNDS/PUBG%20BATTLEGROUNDS.zip" -File "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS.zip"
Clear-Host

# extract config files
Expand-Archive "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS.zip" -DestinationPath "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS" -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# install config files
Copy-Item -Path "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS\*" -Destination "$env:LOCALAPPDATA\TslGame\Saved\Config\WindowsNoEditor" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# cleanup
Remove-Item "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Remove-Item "$env:SystemRoot\Temp\PUBG BATTLEGROUNDS.zip" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host
