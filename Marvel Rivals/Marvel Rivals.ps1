...
Get-FileFromWeb -URL "https://github.com/raspyydev/Game-Configs/raw/refs/heads/main/Marvel%20Rivals/Marvel%20Rivals.zip" -File "$env:SystemRoot\Temp\Marvel Rivals.zip"
Clear-Host

# extract config files
Expand-Archive "$env:SystemRoot\Temp\Marvel Rivals.zip" -DestinationPath "$env:SystemRoot\Temp\Marvel Rivals" -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# install config files
Copy-Item -Path "$env:SystemRoot\Temp\Marvel Rivals\*" -Destination "$env:LOCALAPPDATA\Marvel\Saved\Config\Windows" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# cleanup
Remove-Item "$env:SystemRoot\Temp\Marvel Rivals" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Remove-Item "$env:SystemRoot\Temp\Marvel Rivals.zip" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host
