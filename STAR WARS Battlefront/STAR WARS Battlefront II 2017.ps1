...
Get-FileFromWeb -URL "https://github.com/raspyydev/Game-Configs/raw/refs/heads/main/STAR%20WARS%20Battlefront/STAR%20WARS%20Battlefront%20II%202017.zip" -File "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017.zip"
Clear-Host

# extract config files
Expand-Archive "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017.zip" -DestinationPath "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017" -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# install config files
Copy-Item -Path "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017\*" -Destination "$env:USERPROFILE\Documents\STAR WARS Battlefront II\settings" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Copy-Item -Path "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017\*" -Destination "$env:USERPROFILE\OneDrive\Documents\STAR WARS Battlefront II\settings" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host
...
# install config file
Copy-Item "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017\user.cfg" -Destination "$InstallFolder" -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# cleanup
Remove-Item "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Remove-Item "$env:SystemRoot\Temp\STAR WARS Battlefront II 2017.zip" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
