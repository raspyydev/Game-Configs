...
Get-FileFromWeb -URL "https://github.com/raspyydev/Game-Configs/raw/refs/heads/main/STAR%20WARS%20Battlefront/STAR%20WARS%20Battlefront%20I%202015.zip" -File "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015.zip"
Clear-Host

# extract config files
Expand-Archive "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015.zip" -DestinationPath "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015" -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# install config files
Copy-Item -Path "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015\*" -Destination "$env:USERPROFILE\Documents\STAR WARS Battlefront\settings" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Copy-Item -Path "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015\*" -Destination "$env:USERPROFILE\OneDrive\Documents\STAR WARS Battlefront\settings" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host
...
# install config file
Copy-Item "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015\user.cfg" -Destination "$InstallFolder" -Force -ErrorAction SilentlyContinue | Out-Null
Clear-Host

# cleanup
Remove-Item "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
Remove-Item "$env:SystemRoot\Temp\STAR WARS Battlefront I 2015.zip" -Recurse -Force -ErrorAction SilentlyContinue | Out-Null
